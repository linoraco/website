    ...
    <div className="flex-col">
      ...
      <div className="mx-[10%] md:mx-[15%] lg:mx-[20%]">
        <p className="text-sm sm:text-[16px] mt-1 w-auto text-justify text-[#888888]">
          Author: {berita.nama_pembuat_berita_olahraga}
        </p>
        <p className="text-sm sm:text-[16px] mt-1 w-auto text-justify text-[#888888]">
          {berita.tanggal_berita_olahraga}
        </p>
        <img
          className="py-10 rounded-lg min-[319px]:mx-0 w-[1250px]"
          src={`http://217.15.171.240:4000/images/${berita.gambar_berita_olahraga}`}
          // alt={berita.judul_berita_olahraga}
        />
      </div>
